...
const Hero = ({ title, description, mainActionText, extraActionText }) => {
	return (
		<div id='product'>
			<div
			...
			>
				<div>
					<p className='p-2 text-4xl font-bold text-center text-blue-800 lg:mx-auto lg:text-7xl lg:text-gray-100'>
						{title}
					</p>
				</div>
				<div>
